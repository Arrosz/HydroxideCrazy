...
local web = true
local user = "Arrosz" -- change if you're using a fork
local importCache = {}

-- local read, result = pcall(readfile, "ohaux.lua")
-- if web and read and readfile then
--     local webAux = game:HttpGetAsync('https://raw.githubusercontent.com/Arrosz/HydroxideCrazy/revision/ohaux.lua')
...
local function import(asset)
    ...
    elseif web then
        assets = { loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/" .. user .. "/HydroxideCrazy/revision/" .. asset .. ".lua"), asset .. '.lua')() }
    else
