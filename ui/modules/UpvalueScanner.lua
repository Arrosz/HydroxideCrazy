...
upvalueScriptContext:SetCallback(function()
    ...
    local generatedScript = [[-- Generated by Hydroxide's Upvalue Scanner: https://github.com/Arrosz/HydroxideCrazy

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Arrosz/HydroxideCrazy/revision/ohaux.lua"))()
